...
class Email(object):
    """Provide email service for the application.
    """
    ...
    def __init__(self, env):
        ...
        templates = {}
        templates_dir = os.path.join('emails')
    ...
    def send_email(self, participant, spt_name, **context):
        ...
        message['Destination'] = {}
        message['Destination']['ToAddresses'] = ["%s <%s>" % (participant.username, email)] # "Name <email@domain.com>"
        message['Message'] = {}
